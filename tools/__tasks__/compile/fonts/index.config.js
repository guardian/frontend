        ...
        fonts: [
            {
                'font-weight': '300',
                src:
                    'GuardianHeadline/noalts-not-hinted/GHGuardianHeadline-Light.woff2',
            },
            {
                'font-weight': '300',
                'font-style': 'italic',
                src:
                    'GuardianHeadline/noalts-not-hinted/GHGuardianHeadline-LightItalic.woff2',
            },
            {
                'font-weight': '500',
                src:
                    'GuardianHeadline/noalts-not-hinted/GHGuardianHeadline-Medium.woff2',
            },
            {
                'font-weight': '500',
                'font-style': 'italic',
    ...
    // *** Guardian Headline - woff - Not Hinted ***
    {
        ...
        fonts: [
            ...
            },
            {
                'font-weight': '500',
                src:
                    'GuardianHeadline/noalts-not-hinted/GHGuardianHeadline-Medium.woff',
            },
            {
                'font-weight': '500',
                'font-style': 'italic',
        ...
        fonts: [
            {
                'font-weight': '300',
                src:
                    'GuardianHeadline/noalts-autohinted/GHGuardianHeadline-Light.woff2',
            },
            {
                'font-weight': '300',
                'font-style': 'italic',
                src:
                    'GuardianHeadline/noalts-autohinted/GHGuardianHeadline-LightItalic.woff2',
            },
            {
                'font-weight': '500',
                src:
                    'GuardianHeadline/noalts-autohinted/GHGuardianHeadline-Medium.woff2',
            },
            {
                'font-weight': '500',
                'font-style': 'italic',
    ...
    // *** Guardian Headline - woff - Hinted ***
    {
        ...
        fonts: [
            ...
            },
            {
                'font-weight': '500',
                src:
                    'GuardianHeadline/noalts-autohinted/GHGuardianHeadline-Medium.woff',
            },
            {
                'font-weight': '500',
                'font-style': 'italic',
