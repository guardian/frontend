    ...
    await import('./clean.mjs').then(module => module.default),
    {
      ...
      task: () => {
        ...
        return Promise.all(
          ...
          Object.keys(assetMap).map(asset => cpFile(
          ...
          .then(() => {
            ...
            return Object.assign(
              ...
              webpackEntryBundles.reduce(
                (map, webpackEntryBundle) => Object.assign(map, {
          ...
          ) => mkdirp(resolve(hash, 'assets')).then(() => writeFile(
