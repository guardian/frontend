...
const initialiseBanner = (): void => {
  // ordered by priority
  const bannerList = [cmpBannerCandidate, breakingNews, signInGate, membershipBanner, readerRevenueBanner, smartAppBanner, adFreeBanner, emailSignInBanner, brazeBanner];
