...
const init = (): void => {
  catchErrorsWithContext([['f-accessibility', shouldHideFlashingElements], ['f-snaps', showSnaps], ['f-show-more', showContainerShowMore], ['f-container-toggle', showContainerToggle], ['f-geo-most-popular', upgradeMostPopularToGeo], ['f-lazy-load-containers', lazyLoadContainers], ['f-stocks', stocks], ['f-weather', showWeather], ['f-live-blog-updates', showLiveblogUpdates], ['f-video-playlists', upgradeVideoPlaylists], ['f-audio-flagship-contributions', addContributionBannerToAudioSeries], ['f-finished', finished]]);
};
