...
const validate = (form: HTMLFormElement | null | undefined): boolean => {
    ...
    return typeof emailAddress === 'string' && emailAddress.includes('@');
};
...
const modifyDataLinkName = (modifier: string) => (
...
const modifyLinkNamesForSecondStage = (el: HTMLButtonElement) =>
    modifyDataLinkName('-second-stage')(el);

const modifyLinkNamesForSignedInUser = (el: HTMLButtonElement) =>
...
const createSubscriptionFormEventHandlers = (
    buttonEl: HTMLButtonElement
): void => {
