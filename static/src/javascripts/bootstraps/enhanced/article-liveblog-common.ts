...
const init = (): void => {
  catchErrorsWithContext([['trail-a11y', shouldHideFlashingElements], ['trail-fence', initFence], ['trail-twitter', initTwitter], ['trail-sharing', selectionSharingInit], ['trail-last-modified', lastModified]]);
};
