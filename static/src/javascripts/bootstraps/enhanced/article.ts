...
import { insertTagRichLink, upgradeRichLinks } from "common/modules/article/rich-links";
...
const modules = {
  ...
  initRightHandComponent() {
    ...
    if (!config.hasTone('Match reports') && mainColumn[0] && mainColumn[0].offsetHeight > 1150 && isBreakpoint({
      min: 'desktop'
    })) {
