...
class BinaryToggle extends Component<any, any> {

  render() {
    return <div className="form-field">
                <div className="checkbox">
                    <label className="label" htmlFor={`checkbox-${this.props.name}`}>
                        <input id={`checkbox-${this.props.name}`} key={this.props.name} type="checkbox" data-link-name={this.props.name} defaultChecked={this.props.enabled} onChange={this.props.handleChange.bind(this)} // TODO damn me when I decided to implement this page
...
class Accessibility extends Component<any, any> {
  ...
  render(): Object {
    return <form className="form">
                <fieldset className="fieldset">
                    ...
                    <BinaryToggle key="flashing-elements" name="flashing-elements" label={[<strong key="label">
                                Allow flashing elements
                            </strong>, this.state['flashing-elements'] ? ' Untick this to disable flashing and moving elements' : ' Tick this to enable flashing or moving elements.']} enabled={this.state['flashing-elements']} handleChange={this.toggle.bind(this, 'flashing-elements')} />
                </fieldset>
            </form>;
  }
}
