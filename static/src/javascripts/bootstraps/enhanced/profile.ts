...
const initFormstack = (): void => {
  ...
  const iframes = Array.from(document.getElementsByClassName('js-formstack-iframe'));
...
const initProfile = (): void => {
  const modules: Array<Array<string | Function>> = [['init-form-stack', initFormstack], ['forgotten-email', forgottenEmail], ['password-toggle', passwordToggle], ['init-validation-email', initValidationEmail], ['init-user-avatars', initUserAvatars], ['init-user-edit-link', initUserEditLink], ['init-tabs', initTabs], ['init-account-profile', initAccountProfile], ['setup-loading-animation', setupLoadingAnimation], ['init-public-profile', initPublicProfile], ['enhance-consents', enhanceConsents], ['enhance-ad-prefs', enhanceAdPrefs], ['enhance-form-ajax', enhanceFormAjax], ['enhance-consent-journey', enhanceConsentJourney], ['init-header', initHeader], ['init-upsell', enhanceUpsell]];
