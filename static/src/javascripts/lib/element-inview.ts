...
const elementIsInView = (el: HTMLElement, offsets_?: offsetType): boolean => {
  const offsets = Object.assign({}, { left: 0, right: 0, top: 0, bottom: 0 }, offsets_);
...
const elementInView = (element: HTMLElement, container: HTMLElement, offsets?: offsetType): {
  on: (eventName: "firstview", callback: (el: HTMLElement) => void | null | undefined) => void;
} => {
