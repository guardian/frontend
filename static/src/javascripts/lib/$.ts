...
const $ = (selector: (string | null | undefined) | (Node | null | undefined), context: (Node | null | undefined) | (string | null | undefined)): bonzo => bonzo(qwery(selector, context));

$.create = (s: string | Node): bonzo => bonzo(bonzo.create(s));

// #? duplicated in lib/closest.js?
$.ancestor = (el: Node | null | undefined, className: string): Node | null | undefined => {
