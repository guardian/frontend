...
new Injector()
    .test(['common/modules/commercial/build-page-targeting',
           'common/utils/config',
    ...
    function (buildPageTargeting, config, cookies, detect, userAdTargeting, ab, krux, audienceScienceGateway, criteo) {
