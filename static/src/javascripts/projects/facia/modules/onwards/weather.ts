...
export const Weather = {
   ...
   */
  getUserLocation(): Location | null | undefined {
  ...
  getDefaultLocation(): Promise<void> {
    ...
    return this.getWeatherData(`${config.get('page.weatherapiurl')}.json`).then(response => {
  ...
  fetchWeatherData(location: Location): Promise<void> {
    ...
    return this.getWeatherData(`${weatherApiBase}/${location.id}.json?_edition=${edition.toLowerCase()}`).then(response => {
  ...
  fetchForecastData(location: Location): Promise<void> {
    return this.getWeatherData(`${config.get('page.forecastsapiurl')}/${location.id}.json?_edition=${config.get('page.edition').toLowerCase()}`).then(response => {
