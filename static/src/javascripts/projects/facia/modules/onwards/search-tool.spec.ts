...
describe('Search tool', () => {
  ...
  beforeEach(done => {
    container = $.create('<div class="weather"><p class="weather__desc">' + '<span class="u-h">The temperature</span>' + '<span class="weather__time">Now</span>' + '<span class="u-h">is</span>' + '<span class="weather__temp js-weather-temp">35°C</span>' + '</p>' + '<span class="inline-weather-31 inline-weather weather__icon js-weather-icon"></span>' + '<input id="editlocation" class="search-tool__input js-search-tool-input js-weather-input" type="text" value="London" />' + '<ul class="u-unstyled search-tool__list js-search-tool-list"></ul>' + '</div>');
