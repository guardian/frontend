...
/* eslint-disable */
export const initPermutive = (): Promise<void> => new Promise(resolve => {
  ...
  (function (n, e, o, r, i) {
    if (!e) {
      ...
      for (let t = ['addon', 'identify', 'track', 'trigger', 'query', 'segment', 'segments', 'ready', 'on', 'once', 'user', 'consent'], c = 0; c < t.length; c++) {
        const f = t[c];
        e[f] = function (n) {
          return function () {
