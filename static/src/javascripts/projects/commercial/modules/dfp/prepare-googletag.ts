...
initMessenger(type, getStyles, initGetPageTargeting, resize, hide, scroll, viewport, sendClick, background, disableRefresh);
...
const removeAdSlots = (): Promise<void> => {
  ...
  return fastdom.write(() => adSlots.forEach((adSlot: Element) => adSlot.remove()));
};
