...
import { stickyCommentsMpu, stickyMpu } from 'commercial/modules/sticky-mpu';
...
const removeStyleFromAdIframe = (advert: Advert, style: string) => {
    const adIframe: HTMLElement | null | undefined = advert.node.querySelector(
        'iframe'
    );
...
const sizeCallbacks: Record<
    string,
    (arg0: any, arg1: any) => Promise<void>
> = {};
