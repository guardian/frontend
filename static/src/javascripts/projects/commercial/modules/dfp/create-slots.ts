...
const inlineDefinition = {
  sizeMappings: {
    ...
    phablet: [adSizes.outOfPage, adSizes.empty, adSizes.outstreamMobile, adSizes.mpu, adSizes.googleCard, adSizes.outstreamDesktop, adSizes.outstreamGoogleDesktop, adSizes.fluid],
    desktop: [adSizes.outOfPage, adSizes.empty, adSizes.mpu, adSizes.googleCard, adSizes.video, adSizes.outstreamDesktop, adSizes.outstreamGoogleDesktop, adSizes.fluid]
  }
};
...
*/
const createAdSlotElements = (name: string, attrs: Object, classes: Array<string>) => {
  const adSlots = [];
