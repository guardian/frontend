...
export const renderAdvertLabel = (adSlotNode: HTMLElement): Promise<null> => fastdom.read(() => {
...
export const renderStickyAdLabel = (adSlotNode: HTMLElement): Promise<null> => fastdom.write(() => {
...
export const renderStickyScrollForMoreLabel = (adSlotNode: HTMLElement): Promise<null> => fastdom.write(() => {
