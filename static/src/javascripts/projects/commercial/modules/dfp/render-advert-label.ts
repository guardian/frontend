...
const shouldRenderLabel = adSlotNode => !(adSlotNode.classList.contains('ad-slot--fluid') || adSlotNode.classList.contains('ad-slot--frame') || adSlotNode.classList.contains('ad-slot--gc') || adSlotNode.getAttribute('data-label') === 'false' || adSlotNode.getElementsByClassName('ad-slot__label').length);
...
export const renderAdvertLabel = (adSlotNode: HTMLElement): Promise<null> => fastdom.measure(() => {
...
export const renderStickyAdLabel = (adSlotNode: HTMLElement): Promise<null> => fastdom.mutate(() => {
...
export const renderStickyScrollForMoreLabel = (adSlotNode: HTMLElement): Promise<null> => fastdom.mutate(() => {
