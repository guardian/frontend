...
const getBrazeUuid = (): Promise<string | null | undefined> => new Promise(resolve => {
  getUserFromApi(user => {
...
const hasRequiredConsents = (): Promise<boolean> => new Promise(resolve => {
  onConsentChange(({
    tcfv2,
    ccpa,
    aus
...
type AppBoy = {
  ...
  openSession: () => void;
  logInAppMessageButtonClick: (arg0: InAppMessageButtonInstance, arg1: InAppMessage) => void;
  logInAppMessageImpression: (arg0: InAppMessage) => void;
  InAppMessageButton: (arg0: string, arg1: number | null | undefined, arg2: number | null | undefined, arg3: number | null | undefined, arg4: ClickAction | null | undefined, arg5: string | null | undefined, arg6: number | null | undefined) => InAppMessageButtonInstance;
};
...
const FORCE_BRAZE_ALLOWLIST = ['preview.gutools.co.uk', 'preview.code.dev-gutools.co.uk', 'localhost', 'm.thegulocal.com'];
...
'@guardian/braze-components').then(module => {
  ...
  mountDynamic(container, module.BrazeMessage, {
    ...
    logButtonClickWithBraze: (buttonId: number) => {
      if (appboy) {
        ...
        appboy.logInAppMessageButtonClick(thisButton, messageConfig);
      }
    },
