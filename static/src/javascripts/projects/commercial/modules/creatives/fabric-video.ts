...
class FabricVideo {
  ...
  create() {
    ...
    return fastdom.mutate(() => {
      ...
      this.adSlot.insertAdjacentHTML('beforeend', fabricVideoTpl({
        data: this.params
      }));
      ...
      if (this.adSlot.parentNode && this.adSlot.parentNode instanceof Element && this.adSlot.parentNode.classList.contains('top-banner-ad-container')) {
