...
describe('Liveblog Dynamic Adverts', () => {
  ...
  it.skip('should insert ads every 5th block', () => init().then(() => {
    const adSlots = document.querySelectorAll('.js-liveblog-body .ad-slot');
    const candidates = document.querySelectorAll('.js-liveblog-body > *:nth-child(5n+1)');
    const candidatesAreAllAds = Array.prototype.every.call(candidates, c => c.classList.contains('ad-slot'));
