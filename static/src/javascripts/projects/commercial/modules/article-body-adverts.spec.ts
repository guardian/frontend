...
import { getViewport as getViewport_, getBreakpoint as getBreakpoint_, isBreakpoint as isBreakpoint_ } from "lib/detect";
...
const spaceFillerStub: JestMockFn<any, any> = (spaceFiller.fillSpace as any);
