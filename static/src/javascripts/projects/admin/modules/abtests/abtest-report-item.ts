...
class ABTestReportItem extends Component {
    ...
    prerender(): void {
        ...
        if (elements.audience) {
            elements.audience.textContent = `${
                this.config.test.audience * 100
            }%`;
        }

        if (elements.audienceOffset) {
            elements.audienceOffset.textContent = `${
                this.config.test.audienceOffset * 100
            }%`;
        }
