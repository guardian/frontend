...
const articleBodyWithCalloutBoxes = '<div class="content__article-body"><h1>title</h1><p>one</p><p>two</p><figure data-alt="Callout callout-hij"></figure><p>three</p><p>four</p><figure data-alt="Callout callout-klm"></figure></div>';
const articleBody = '<div className="content__article-body"><h1>title</h1><p>one</p><p>two</p><p>three</p><p>four</p></div>';
const renderedCallout = '<figure class="element element-campaign"><div></div></figure>';
...
describe('If a callout container and callout data are both present', () => {
  ...
  it('puts the callout in the right container', () => {
    initCampaign();
    expect(document.querySelectorAll('figure')[0].innerHTML).toEqual(renderedCallout);
  });
});
