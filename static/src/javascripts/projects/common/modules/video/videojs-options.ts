...
const defaults = {
  ...
  controlBar: {
    children: ['playToggle', 'currentTimeDisplay', 'timeDivider', 'durationDisplay', 'progressControl', 'fullscreenToggle', 'volumeMenuButton']
  },
...
export default ((overrides: Object = {}): Object => Object.assign({}, defaults, overrides));