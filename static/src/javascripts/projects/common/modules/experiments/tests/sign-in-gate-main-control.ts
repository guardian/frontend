...
export const signInGateMainControl: ABTest = {
  ...
  description: 'Show sign in gate to 100% of users on 3rd article view of simple article templates, with higher priority over banners and epic. Control Audience.',
  audience: 0.09,
  audienceOffset: 0.9,
