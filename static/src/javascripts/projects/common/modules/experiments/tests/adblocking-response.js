                ...
                detect.adblockInUse.then(function (adblockUsed) {
                    if (adblockUsed && !config.page.isFront &&
                        ...
                        var surveyOverlay = new SurveyAdBlock({
                            ...
                            surveyTextSubscriber: 'Are you a print subscriber? ' + '<a class=\"text-link\" href=\"/commercial/subscriber-number" target=\"_blank\" data-link-name=\"adblock subscriber no-close\">please click here.</a>',
                            surveyTextUserHelp: 'If you\'re unable to disable your ad blocking software for any reason, please contact ' + '<a class=\"text-link\" href="mailto:userhelp@theguardian.com" data-link-name="user help email no-close">userhelp@theguardian.com.</a>',
                ...
                detect.adblockInUse.then(function (adblockUsed) {
                    if (adblockUsed && !config.page.isFront &&
                        ...
                        var surveyOverlay = new SurveyAdBlock({
                            ...
                            surveyTextSubscriber: 'Are you a print subscriber? ' + '<a class=\"text-link\" href=\"/commercial/subscriber-number" target=\"_blank\" data-link-name=\"adblock subscriber immediate-close\">please click here.</a>',
                            surveyTextUserHelp: 'If you\'re unable to disable your ad blocking software for any reason, please contact ' + '<a class=\"text-link\" href="mailto:userhelp@theguardian.com" data-link-name="user help email immediate-close">userhelp@theguardian.com.</a>',
                            subscriberLink: '/commercial/subscriber-number',
                            subscriberText: 'Subscriber number',
                ...
                detect.adblockInUse.then(function (adblockUsed) {
                    if (adblockUsed && !config.page.isFront &&
                        ...
                        var surveyOverlay = new SurveyAdBlock({
                            ...
                            surveyTextSubscriber: 'Are you a print subscriber? ' + '<a class=\"text-link\" href=\"/commercial/subscriber-number" target=\"_blank\" data-link-name=\"adblock subscriber delayed-close\">please click here.</a>',
                            surveyTextUserHelp: 'If you\'re unable to disable your ad blocking software for any reason, please contact ' + '<a class=\"text-link\" href="mailto:userhelp@theguardian.com" data-link-name="user help email delayed-close">userhelp@theguardian.com.</a>',
                            subscriberLink: '/commercial/subscriber-number',
                            subscriberText: 'Subscriber number',
