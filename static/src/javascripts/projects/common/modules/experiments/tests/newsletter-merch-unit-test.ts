...
export const newsletterMerchUnitLighthouseVariant: ABTest = {
  ...
  expiry: '2020-12-08',
  author: 'Josh Buckland & Alex Dufournet',
  description: 'Show a newsletter advert in the merchandising unit to 25% of users and reader revenue' + 'to another 25%. The remaining 50% are covered by NewsletterMerchUnitLighthouseControl ' + 'which needs to run at the same time. These two variants test the value of showing ' + 'newsletter merch units instead of reader revenue ones.',
  audience: 0.5,
  audienceOffset: 0.5,
  successMeasure: 'We see increased engagement from users shown the Newsletters ad unit',
  audienceCriteria: 'Website users only.',
