...
const abTestName = 'AcquisitionsEpicUsEndOfYearRoundFour';

export const acquisitionsEpicUsEndOfYearRoundFour: EpicABTest = makeABTest({
    id: abTestName,
    ...
    author: 'Emma Milner',
    description: 'Tests three epics with custom copy in US',
