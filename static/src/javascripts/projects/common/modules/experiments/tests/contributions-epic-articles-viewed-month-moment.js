...
export const variantCopy = (articleCountParagraph: string) => ({
    heading: 'Since we published our environmental pledge...',
    paragraphs: [
        '... Guardian readers from more than 100 countries across the world have supported us – thank you. Many of you have told us how much you value our commitment: to be truthful, resolute and undeterred in pursuing this important journalism. We are galvanised by your generous support as it makes our work possible.',
        'The Guardian will not stay quiet on the escalating climate crisis and we recognise it as the defining issue of our lifetimes. We will give global heating, wildlife extinction and pollution the urgent attention they demand. Our independence means we can interrogate inaction by those in power. It means Guardian reporting will always be driven by scientific facts, never by commercial or political interests.',
...
export const articlesViewedMonthMomentFinal: EpicABTest = makeEpicABTest({
    ...
    campaignId:
        '2019-10-14_moment_climate_pledge_v2_article_count_month',
    ...
    variants: [
        {
            ...
            products: [],
            copy: buildEpicCopy(controlCopy(monthArticleCountParagraph), false, geolocation),
            classNames: [
        ...
        },
        {
            ...
            buttonTemplate: defaultButtonTemplate,
            products: [],
            copy: buildEpicCopy(variantCopy(monthArticleCountParagraph), false, geolocation),
            classNames: [
                'contributions__epic--2019-10-14_moment_climate_pledge',
            ],
            supportBaseURL: url,
