define([], function () {
    return function () {
        ...
        this.dataLinkNames = '';
        this.idealOutcome = 'Higher engagement, measured as increased onward journeys to ANY content on the affected sport front, or increased dewll time on that front';
