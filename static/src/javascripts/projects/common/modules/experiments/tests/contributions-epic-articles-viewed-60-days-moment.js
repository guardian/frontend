...
import {
    controlCopy,
    variantCopy,
} from 'common/modules/experiments/tests/contributions-epic-articles-viewed-month-moment';
...
export const articlesViewed60DaysMomentFinal: EpicABTest = makeEpicABTest({
    ...
    campaignId: '2019-10-14_moment_climate_pledge_v2_article_count_60_days',
    ...
    variants: [
        {
            ...
            products: [],
            copy: buildEpicCopy(
                controlCopy(articleCountParagraph),
                false,
                geolocation
            ),
            classNames: [
        ...
        },
        {
            ...
            products: [],
            copy: buildEpicCopy(
                variantCopy(articleCountParagraph),
                false,
                geolocation
            ),
            classNames: [
