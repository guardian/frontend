...
export const concurrentTests = [genAbTest('DummyTest'), genAbTest('DummyTest2'), genAbTest('DummyTest3CanRunIsFalse', false), genAbTest('DummyTest4ControlCanRunIsFalse', true, '9999-01-01', [genVariant('control', false), genVariant('variant', true)])];
