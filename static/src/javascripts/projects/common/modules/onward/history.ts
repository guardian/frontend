...
let historyCache: any[][] | null | undefined;
let summaryCache: Object | null | undefined;
let popularFilteredCache: any[][] | null | undefined;
let topNavItemsCache: string[] | null | undefined;
let inMegaNav = false;

const saveHistory = (history: any[][]): void => {
...
const tally = (visits: number[][], weight = 1, minimum = 1): number => {
    let totalVisits = 0;
...
const getPopular = (opts: Object | null | undefined): string[][] => {
...
const getPopularFiltered = (opts?: Object): any[][] => {
...
const tagHtml = (
    ...
    index: number
        ...
        <a href="/${
            tag[0]
        }" class="button button--small button--tag button--secondary" data-link-name="${
    index + 1
} | ${tag[1]}">${tag[1]}</a>
    </li>`;
