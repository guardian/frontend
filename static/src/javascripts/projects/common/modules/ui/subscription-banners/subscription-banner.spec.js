...
describe('Subscription Banner', () => {
    ...
    it('Should append a Subscription Banner to the document', () => {
        ...
        const show = createBannerShow(mockTracking, subscripionBannerTemplate, false);
        show()

        const banner = subscripionBannerTemplate(mockTracking.subscriptionUrl, mockTracking.signInUrl, false);
    ...
    describe('Banner Tracking', () => {
        ...
        it('Should call trackCloseButtons when close button is clicked', () => {
            ...
            const show = createBannerShow(mockTrackingSUT, subscripionBannerTemplate, false);
            show();
        ...
        it('should hide sign-in link if user is signed in', () => {
            ...
            const show = createBannerShow(mockTrackingSUT, subscripionBannerTemplate, isUserSignedIn);
            show();
