...
const AUS_CAMPAIGN_CODE = 'gdnwb_copts_banner_subscribe_SubscriptionBanner_gWeekly';
...
const createTracking = (region: ReaderRevenueRegion, defaultTracking: BannerTracking) => {
    ...
    return isAustralianRegion ? { ...defaultTracking, ...australianTracking } : defaultTracking;
}

export const tracking = (region: ReaderRevenueRegion) => {
    ...
    const defaultTracking = {
        ...
        trackSubscriptionBannerClick: button => {
            submitClickEvent({
                component: {
                    componentType: COMPONENT_TYPE,
                    id:
        ...
        trackSubscriptionCloseButtons: button => {
            submitClickEvent({
                component: {
                    componentType: COMPONENT_TYPE,
                    id:
