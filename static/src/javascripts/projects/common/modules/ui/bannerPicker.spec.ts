...
describe('bannerPicker', () => {
  describe('bannerPicker picks correct banner to show', () => {
    ...
    const tests = [{
      description: 'should call show() for successful bannerIndex 0 when no other checks in list',
      resultsSeq: [{
        bannerIndex: 0,
        value: true
      }],
      ...
      description: 'should call show() for successful bannerIndex 1 when bannerIndex 0 fails',
      resultsSeq: [{
        bannerIndex: 0,
        value: false
      }, {
      ...
      description: 'should call show() for successful bannerIndex 0 even if bannerIndex 1 passes',
      resultsSeq: [{
        bannerIndex: 0,
        value: true
      }, {
      ...
      description: 'should call show() for successful bannerIndex 1 when bannerIndex 1 fails',
      resultsSeq: [{
        bannerIndex: 0,
        value: false
      }, {
      ...
      description: 'should call show() for successful bannerIndex 0 even if bannerIndex 1 passes first',
      resultsSeq: [{
        bannerIndex: 1,
        value: true
      }, {
      ...
      description: 'should call show() for successful bannerIndex 2 when higher priority bannerIndexes 0 & 1 fail',
      resultsSeq: [{
        bannerIndex: 1,
        value: false
      }, {
    ...
    tests.forEach(test => {
      it(test.description, () => {
        ...
        const newCheck = () => () => new Promise(resolve => {
  ...
  describe('bannerPicker picks correct banner to show when check timesout', () => {
    it('should call show() for banner at index 1 if index 0 timesout', () => {
       ...
       * */
      const onCheckResolved = () => new Promise(resolve => {
