...
const getTabTarget = (tab: HTMLElement): Promise<string | null | undefined> => fastdom.read(() => tab.getAttribute('href'));
...
const init = (): Promise<void> => {
  const findTabs = (): Promise<Array<HTMLElement>> => fastdom.read(() => Array.from(document.querySelectorAll('.tabs')));
