...
const getTabTarget = (tab: HTMLElement): Promise<string | null | undefined> => fastdom.measure(() => tab.getAttribute('href'));
...
const init = (): Promise<void> => {
  const findTabs = (): Promise<Array<HTMLElement>> => fastdom.measure(() => Array.from(document.querySelectorAll('.tabs')));
