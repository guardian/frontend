...
export default class ProgressBar extends Component<Props, State> {
  ...
  getElement = (el: HTMLElement | null | undefined) => {
    if (el) {
      this.element = el;
    }
  };
  ...
  render() {
    return <Progress ref={this.getElement} backgroundColor={this.props.backgroundColor} highlightColor={this.props.highlightColor} barContext={this.props.barContext} height={this.props.barHeight} onMouseDown={this.start} role="progressbar" aria-valuenow={this.state.dragging ? this.state.draggingValue : this.props.value} aria-valuemin="0" aria-valuemax="100">
                <Track className="track-foreground" backgroundColor={this.props.trackColor} width={pct(this.props.value)} />
