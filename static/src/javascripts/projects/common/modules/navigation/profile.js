...
class Profile {
    ...
    setFragmentFromCookie() {
        const user = id.getUserFromCookie(), $container = bonzo(this.dom.container), $content = bonzo(this.dom.content), $register = bonzo(this.dom.register), $commentActivity = bonzo(this.dom.commentActivity);
