...
const getMeasurements = (
    ...
    const contentMeta: HTMLElement | null | undefined = rules.clearContentMeta
    ...
    return fastdom.measure(() => {
        ...
        const contentMetaWithDims: SpacefinderItem | null | undefined =
            rules.clearContentMeta && contentMeta
                ? getDimensions(contentMeta)
                : null;
        const opponentsWithDims:
            | ElementDimensionMap
            | null
            | undefined = opponents
...
const findSpace = (
    rules: SpacefinderRules,
    options: SpacefinderOptions | null | undefined,
    excluded: SpacefinderExclusions | null | undefined
): Promise<HTMLElement[]> => {
    rules.body =
