define([
    ...
    return function (opts) {
        var win         = (opts || {}).window || window,
            ...
            ophanViewId = config.ophan.pageViewId,
            pageTargets = _.merge({
                ...
                x:       krux.getSegments(),
                su:      page.isSurging,
                pv1:     ophanViewId.slice(0,20),
                pv2:     ophanViewId.slice(20,40),
                pv3:     ophanViewId.slice(40,60),
                pv4:     ophanViewId.slice(60,80),
                pv5:     ophanViewId.slice(80,100),
