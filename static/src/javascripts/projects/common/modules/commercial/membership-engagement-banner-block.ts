 ...
 */
type SwitchBlockConfig = Record<string, BlockConfig>;
...
const allSwitches: string[] = ['Uk', 'Us', 'Au'].map(
    (region) => `membershipEngagementBannerBlock${region}`
);

export const isBlocked = (
    switches: string[] = allSwitches,
    ...
    const activeBlockConfigs: BlockConfig[] = switches
    ...
    const blockedUrls: string[] = flattenDeep(
