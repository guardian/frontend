...
import { isPayingMember as isPayingMember_, isRecentOneOffContributor as isRecentOneOffContributor_, shouldHideSupportMessaging as shouldHideSupportMessaging_, isAdFreeUser as isAdFreeUser_ } from "common/modules/commercial/user-features";

const isPayingMember: JestMockFn<any, any> = (isPayingMember_ as any);
const isRecentOneOffContributor: JestMockFn<any, any> = (isRecentOneOffContributor_ as any);
const shouldHideSupportMessaging: JestMockFn<any, any> = (shouldHideSupportMessaging_ as any);
const isAdFreeUser: JestMockFn<any, any> = (isAdFreeUser_ as any);
...
describe('Commercial features', () => {
  ...
  describe('Third party tags', () => {
    ...
    it('Does not run on the secure contact interactive', () => {
      config.set('page.pageId', 'help/ng-interactive/2017/mar/17/contact-the-guardian-securely');
    ...
    it('Does not run on secure contact help page', () => {
      config.set('page.pageId', 'help/2016/sep/19/how-to-contact-the-guardian-securely');
