        ...
        <div class="epic-reminder__signup">
            ...
            <div class="epic-reminder__form-wrapper">
                <form>
                    ...
                    <div class="epic-reminder__email-input-wrapper">
                        ...
                        <div class="epic-reminder__submit-button-wrapper">
                            <button data-reminder-date="${reminderFields.reminderDate}" type="submit" class="epic-reminder__submit-button component-button component-button--hasicon-right" id="epic-reminder__submit-button">
                                Set my reminder
                ...
                <p class="epic-reminder__email-terms-and-conditions">
                    We will use this to send you a single email in ${reminderFields.reminderDateAsString}. To find out what personal data we collect and how we use it, please visit our <a href="https://www.theguardian.com/help/privacy-policy">Privacy Policy</a>
                </p>
            </div>

            <div class="epic-reminder__thank-you">
                We will be in touch to invite you to contribute. Look out for a message in your inbox in ${reminderFields.reminderDateAsString}. If you have any questions about contributing, please <a href="mailto:contribution.support@theguardian.com">contact us here</a>.
            </div>
        </div>
    </div>
`;
