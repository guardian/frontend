define([
    ...
    'template!common/views/commercial/creatives/logo-header.html',
    'template!common/views/commercial/creatives/logo-link.html',
    'template!common/views/commercial/creatives/logo-about.html',
    'template!common/views/commercial/creatives/manual-inline-button.html',
    'template!common/views/commercial/creatives/gimbap/gimbap-simple-blob.html',
    'template!common/views/commercial/creatives/gimbap/gimbap-richmedia-blob.html',
    'template!common/views/commercial/creatives/manual-card.html',
    'template!common/views/commercial/creatives/manual-card-large.html',
    'template!common/views/commercial/creatives/manual-card-cta.html',
    'template!common/views/commercial/creatives/manual-container-button.html',
    'template!common/views/commercial/creatives/manual-container-cta.html',
    'template!common/views/commercial/creatives/manual-container-cta-soulmates.html',
    'template!common/views/commercial/creatives/manual-container-cta-membership.html'
], function (
    svgs,
    config,
    assign,
