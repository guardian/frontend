...
export const overwriteMvtCookie = (testId: number): void => addCookie(MULTIVARIATE_ID_COOKIE, String(testId), 365);

export const getMvtValue = (): number => Number(getCookie(MULTIVARIATE_ID_COOKIE));
