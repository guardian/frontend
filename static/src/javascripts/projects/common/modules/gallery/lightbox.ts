...
import { pushUrl, supportsPushState, back as urlBack } from 'lib/url';
...
class GalleryLightbox {
    ...
    generateImgHTML(img: Object, i: number): string {
        const blockShortUrl =
            config.get('page.host') + config.get('page.shortUrlId');
    ...
    static loadNextOrPrevious(
        ...
        return fetch(fetchUrl)
            ...
            .then((
                json // filter out non-lightbox items in the series
