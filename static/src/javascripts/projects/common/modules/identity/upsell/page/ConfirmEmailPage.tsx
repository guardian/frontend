...
const Components = (props: Props): React.Component => {
  ...
  if (!props.hasPassword && !props.hasSocialLinks && props.accountToken) {
    components = [<AccountCreationBlock csrfToken={props.csrfToken} accountToken={props.accountToken} email={props.email} />, <NewsLetterSignUps />, <OptOuts />];
...
export const ConfirmEmailPage = (props: Props): React.Component => <div className="identity-upsell-wrapper">
