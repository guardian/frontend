...
const Header = ({
  title,
  subtitle
}: HeaderProps) => <div className="identity-upsell-subheader">
        ...
        <div className="identity-upsell-subheader__graphics">
            <span className="identity-upsell-subheader__graphic identity-upsell-subheader__graphic--circlesLeft" dangerouslySetInnerHTML={{ __html: circlesLeft.markup }} />
            <span className="identity-upsell-subheader__graphic identity-upsell-subheader__graphic--circlesRight" dangerouslySetInnerHTML={{ __html: circlesRight.markup }} />
        </div>
    </div>;
