...
import { isUserLoggedIn, getUserFromApiWithRefreshedCookie } from "common/modules/identity/api";
import { local as localStorage } from "lib/storage";

const shouldRefreshCookie = (lastRefresh: number | null | undefined, currentTime: number): boolean => {
