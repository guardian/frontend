...
import { isNPageOrHigherPageView, isLoggedIn, isInvalidArticleType, isInvalidSection, isInvalidTag, isIOS9, setGatePageTargeting, hasUserDismissedGateMoreThanCount } from "../../helper";
...
const canShow: (name?: string) => boolean = (name = '') => {
  const isGateDismissed = hasUserDismissedGateMoreThanCount(variant, name, componentName, 5);
