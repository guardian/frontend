...
import { isLoggedIn, isNPageOrHigherPageView, isInvalidArticleType, isInvalidSection, isIOS9, setGatePageTargeting, unsetUserDismissedGate } from "../../helper";
...
const canShow: () => boolean = () => {
  ...
  const canShowCheck = isNPageOrHigherPageView(3) && !isLoggedIn() && !isInvalidArticleType() && !isInvalidSection() && !isIOS9();
