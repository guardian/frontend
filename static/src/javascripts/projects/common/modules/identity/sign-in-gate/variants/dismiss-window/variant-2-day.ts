...
import { CurrentABTest, SignInGateVariant } from "../../types";
import { componentName } from "../../component";
import { hasUserDismissedGateInWindow, isNPageOrHigherPageView, isLoggedIn, isInvalidArticleType, isInvalidSection, isIOS9, setGatePageTargeting } from "../../helper";
...
const canShow: (name?: string) => boolean = (name = '') => {
  ...
  const canShowCheck = !isGateDismissed && isNPageOrHigherPageView(3) && !isLoggedIn() && !isInvalidArticleType() && !isInvalidSection() && !isIOS9();
