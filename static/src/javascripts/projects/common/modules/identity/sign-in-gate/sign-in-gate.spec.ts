...
describe('Sign in gate test', () => {
  ...
  describe('canShow returns true', () => {
    it('should return true using default mocks', () => signInGate.canShow().then(show => {
  ...
  describe('canShow returns false', () => {
    it('should return false if not in correct test', () => {
      ...
      fakeIsInABTestSynchronous.mockReturnValueOnce(false).mockReturnValueOnce(false).mockReturnValueOnce(false).mockReturnValueOnce(false);
