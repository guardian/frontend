...
<div class="signin-gate">
    <div class="signin-gate__content--var">
        ...
        <div class="signin-gate__paragraph--var">
            ...
            <p class="signin-gate__paragraph--text--var">
               When you register with us we are able to improve our news experience for you and for others.
               You will always be able to control your own <a id="js-signin-gate__privacy" class="signin-gate__link--var">privacy settings</a>. Thank you.
            </p>
        </div>
