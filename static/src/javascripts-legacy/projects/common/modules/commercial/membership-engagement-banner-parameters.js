define(
    ['lib/config', 'lib/storage', 'lodash/objects/assign', 'lib/geolocation'],
    function(config, storage, assign, geolocation) {
        var offerings = {
        ...
        function contributionEngagementBannerCopy() {
            return engagementBannerCopy(
                'Support us with a one-off contribution'
            );
        }
