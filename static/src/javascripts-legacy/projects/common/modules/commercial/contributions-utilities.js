define(
    ...
    function(
        ...
        var lastContributionDate = cookies.getCookie(
     ...
     */
        ...
        var daysSinceLastContribution = timeUtils.daysSince(
        ...
        function defaultCanEpicBeDisplayed(testConfig) {
            ...
            var worksWellWithPageTemplate = typeof testConfig.pageCheck ===
                'function'
        ...
        function ContributionsABTest(options) {
            ...
            this.isEngagementBannerTest =
                options.isEngagementBannerTest || false;
        ...
        function ContributionsABTestVariant(options, test) {
            ...
            this.options = {
                ...
                componentName:
                    'mem_acquisition_' + trackingCampaignId + '_' + this.id,
                template: options.template || controlTemplate,
                testimonialBlock:
                    options.testimonialBlock ||
                        getTestimonialBlock(
                            acquisitionsTestimonialParameters.control
                        ),
            ...
            this.test = function() {
                var displayEpic = typeof options.canEpicBeDisplayed ===
                    'function'
        ...
        ContributionsABTestVariant.prototype.getURL = function(
            base,
            campaignCode
        ) {
            var params = {
