    ...
    function(
        ...
        return function(opts) {
            var options = assign(
                {
                    ...
                    minUpdateDelay:
                        (detect.isBreakpoint({ min: 'desktop' }) ? 10 : 30) *
                            1000, // 10 or 30 seconds minimum, depending on breakpoint
            ...
            var checkForUpdates = function() {
                ...
                var latestBlockIdToUse = latestBlockId
                    ? latestBlockId
                    : 'block-0';
                var count = 0;
                var endpoint =
            ...
            var setUpListeners = function() {
                ...
                mediator.on(
                    'modules:detect:pagevisibility:visible',
                    function() {
                        if (unreadBlocksNo == 0) {
                            revealInjectedElements();
                        }
