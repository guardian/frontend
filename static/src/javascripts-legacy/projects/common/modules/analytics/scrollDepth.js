define(
    ...
    function(mediator, assign, bindAll, debounce) {
        ...
        ScrollDepth.prototype.setData = function(type) {
            ...
            if (
                currentDepth - this.data[type].depth >
                this.opts.changeThreshold
            ) {
                this.data[type].depth = currentDepth;
                if (typeof this.data[type].duration === 'number') {
                    this.data[type].duration = this.timeSince(
        ...
        ScrollDepth.prototype.init = function() {
            mediator.on(
                ...
                debounce(this.assertScrolling, 200)
            );
