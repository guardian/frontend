    ...
    function(
        ...
        function parseResponse(response) {
            return (response.collections || [])
                .filter(function(collection) {
                    return (
                        isArray(collection.content) && collection.content.length
                    );
                })
        ...
        function init() {
            if (userCanDismissAlerts()) {
                knownAlertIDs =
                    storage.local.get(knownAlertIDsStorageKey) || {};
