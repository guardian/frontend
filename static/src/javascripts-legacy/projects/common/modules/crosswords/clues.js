define(
    ...
    function(React, bean, fastdom, classNames, detect, scroller) {
                    ...
                    React.createElement(
                        'a',
                        {
                            ...
                            className: classNames({
                                ...
                                'crossword__clue--answered': this.props
                                    .hasAnswered,
                                'crossword__clue--selected': this.props
                                    .isSelected,
        ...
        var Clues = React.createClass({
            ...
            componentDidMount: function() {
                ...
                bean.on(
                    ...
                    function(e) {
                        var showGradient =
                            height - e.currentTarget.scrollTop > 25;
         ...
         */
            componentDidUpdate: function(prev) {
                if (
                    ...
                    (!prev.focussed ||
                        prev.focussed.id !== this.props.focussed.id)
                ) {
                    fastdom.read(
                        function() {
            ...
            scrollIntoView: function(clue) {
                ...
                if (!visible) {
                    var offset =
                        node.offsetTop - this.$cluesNode.clientHeight / 2;
                    scroller.scrollTo(
                        offset,
                        250,
                        'easeOutQuad',
