define(
    ...
    function(mediator, detect, $, fetch, bean, config, ophan) {
                ...
                if (question) {
                    ...
                    if (questionText && atomId) {
                        ...
                        if (isEmailSubmissionReady === 'true') {
                            ...
                            if (
                                thankYouMessageForEmailSubmission &&
                                signupForm
                            ) {
                            ...
                            var thankYouMessageNoEmailSubmission = document.getElementById(
                                'js-thankyou-message-no-submission-' +
                                    questionId
                            );
        ...
        return {
            init: function() {
                ...
                if (isEmailSubmissionReadyElement) {
                    isEmailSubmissionReady = isEmailSubmissionReadyElement
                        .dataset.isEmailSubmissionReady
                        ? isEmailSubmissionReadyElement.dataset
