define([
    ...
    return contributionsUtilities.makeABTest({
        id: 'AcquisitionsEpicContentTailoringFootball',
        campaignId: 'kr1_epic_content_tailoring_football',

        start: '2017-03-15',
        expiry: '2017-04-10',

        author: 'Alex Dufournet',
        description: 'This targets articles in the football section in order to test specific messages',
        ...
        canRun: function canRun() {
          return config.page.section == "football";
        },

        variants: [
            buildVariant("control"),
            buildVariant("impact", {p1End: ' The Guardian’s football coverage takes a lot of time, money and hard work to produce. But we do it because we believe in digging beneath the surface, being on the side of fans and covering the global game.'}),
            buildVariant("reference", {p1End: ' The Guardian’s football coverage takes a lot of time, money and hard work to produce. But we do it because we believe our perspective matters – because it might well be your perspective, too.'})
        ]
    });
});
