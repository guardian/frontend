define(
    ['fastdom', 'qwery', 'lib/$', 'lib/config', 'lib/fastdom-promise'],
    function(fastdom, qwery, $, config, fastdomPromise) {
        return function() {
            ...
            this.audienceCriteria =
                'All users who visit the email sign up page';
            this.dataLinkNames = '';
            this.idealOutcome =
            ...
            function enhanceWebView(emailListID) {
                ...
                emailForm.setAttribute(
                    'src',
                    'https://www.theguardian.com/email/form/plaintone/' +
                        emailListID
                );
            }
