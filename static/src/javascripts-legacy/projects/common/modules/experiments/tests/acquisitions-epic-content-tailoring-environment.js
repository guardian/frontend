define([
    ...
    return contributionsUtilities.makeABTest({
        id: 'AcquisitionsEpicContentTailoringEnvironment',
        campaignId: 'kr1_epic_content_tailoring_environment',

        start: '2017-03-15',
        expiry: '2017-04-10',

        author: 'Alex Dufournet',
        description: 'This targets articles in the environment section in order to test specific messages',
        ...
        variants: [
            ...
            buildVariant("impact", {p1End: ' The Guardian’s independent, investigative environmental coverage takes a lot of time, money and hard work to produce. But we do it because we believe the threat to our planet, which disproportionately impacts the poorest, is one of the most pressing issues of our time - and yet too often overlooked.'}),
            buildVariant("reference", {p1End: ' The Guardian’s independent, investigative environmental coverage takes a lot of time, money and hard work to produce. But we do it because we believe our perspective matters – because it might well be your perspective, too.'})
        ]
    });
});
