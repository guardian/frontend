            ...
            },
            {
                ...
                template:  function(variant) {
                    return template(acquisitionsEpicTestTemplate, {
                        ...
                        contributionUrl: variant.options.contributeURL,
                        componentName: variant.options.componentName,
                        p1: '&hellip; we’ve got a small favour to ask. Whoever wins the UK election, we promise to hold them to account with facts you can trust and opinions you can believe in. But advertising revenues are falling, <span class="contributions__highlight">the Guardian has no billionaire owner</span> and <span class="contributions__highlight">unlike many news organisations, we haven’t put up a paywall &ndash; we want to keep our journalism as open as we can</span>. So you can see why we need to ask for your help. The Guardian’s independent, investigative journalism takes a lot of time, money and hard work to produce. But we do it because we believe our perspective matters &ndash; because it might well be your perspective, too.',
