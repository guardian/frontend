define(
    ...
    function(commercialFeatures, contributionsUtilities, config, cookies) {
        function canBeDisplayed() {
            var userHasNeverContributed = !cookies.getCookie(
                'gu.contributions.contrib-timestamp'
            );
            var worksWellWithPageTemplate =
                config.page.contentType === 'Article' &&
                !config.page.isMinuteArticle; // may render badly on other types
