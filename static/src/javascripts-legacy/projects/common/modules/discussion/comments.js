    ...
    function(
        ...
        Comments.prototype.handlePickClick = function(e) {
            ...
            var commentId = e.target.getAttribute('data-comment-id'),
                $thisButton = $(e.target),
                promise = $thisButton[0].getAttribute(
                ...
                promise = new WholeDiscussion({
                    ...
                    .catch(
                        function() {
                            ...
                            return fetchJson(
                                url + '?' + urlUtil.constructQuery(queryParams),
                                ajaxParams
                            );
                        }.bind(this)
                    );
 ...
 */
        ...
        Comments.prototype.replyToComment = function(e) {
            ...
            var replyToComment = qwery('#comment-' + replyToId)[0],
                replyToAuthor = replyToComment.getAttribute(
                    'data-comment-author'
                ),
                replyToAuthorId = replyToComment.getAttribute(
