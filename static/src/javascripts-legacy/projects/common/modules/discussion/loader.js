define(
    ...
    function(
        ...
        Loader.prototype.initMainComments = function() {
            ...
            var threading =
                userPrefs.get('discussion.threading') || 'collapsed';

            var defaultPagesize = detect.isBreakpoint({ min: 'tablet' })
                ? 25
                : 10;
        ...
        Loader.prototype.logError = function(commentType, error) {
            ...
            raven.captureMessage(reportMsg, {
                tags: {
                    ...
                    readyState: 'readyState' in request
                        ? request.readyState
                        : '',
        ...
        Loader.prototype.initPageSizeDropdown = function(pageSize) {
            ...
            this.on(
                ...
                function(e) {
                    ...
                    var selectedPageSize = bonzo(e.currentTarget).data(
                        'pagesize'
                    );
        ...
        Loader.prototype.initToolbar = function() {
            ...
            this.on(
                ...
                function(e) {
                    bean.fire(
                        qwery(
                            '.js-comment-threading-dropdown [data-toggle]'
                        )[0],
                        'click'
                    );
        ...
        Loader.prototype.renderCommentBar = function() {
            if (this.isCommentable()) {
                this.renderCommentBox(
                    qwery('.js-discussion-comment-box--top')[0]
                );
                this.renderCommentBox(
                ...
                if (commentsAreHidden) {
                    fastdom
                        .write(function() {
                            ...
                            $showAllButton.length &&
                                $showAllButton.addClass('u-h');
                        })
                        .then(function() {
