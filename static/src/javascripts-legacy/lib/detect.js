...
define(
    ['lib/mediator', 'lodash/functions/memoize', 'lib/window-performance'],
    function(mediator, memoize, performanceAPI) {
     ...
     */
        function isBreakpoint(criteria) {
            var indexMin = criteria.min
                ? breakpointNames.indexOf(criteria.min)
                : 0;
        ...
        function initPageVisibility() {
            ...
            function onchange(evt) {
                ...
                mediator.emit(
                    'modules:detect:pagevisibility:' + pageVisibility
                );
            }
