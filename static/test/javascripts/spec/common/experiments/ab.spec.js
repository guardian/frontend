...
//                mvtCookie.overwriteMvtCookie(1);
            ...
            describe('User segmentation', function () {
                ...
                it('should not run if switch is off', function (ab, deps) {
                    deps['common/utils/config'].switches.abDummyTest = false;
                ...
                it('should assign the user to a segment (aka. variant)', function (ab) {
                    ab.addTest(test.one);
                    ab.addTest(test.two);
                    ab.segment();
                ...
                it('should put all non-participating users in a "not in test" group', function (ab) {
                    test.one.audience = 0;
                    ab.addTest(test.one);
                    ab.segment();
                ...
                it("should not segment user if test can't be run", function (ab) {
                ...
                it("should not segment user if the test has expired", function (ab) {
                ...
                it("should not segment user if the test is switched off", function (ab, deps) {
                    deps['common/utils/config'].switches.abDummyTest = false;
                ...
                it("should not segment user if they already belong to the test", function (ab, deps) {
                    deps['common/modules/analytics/mvt-cookie'].overwriteMvtCookie(1);
                ...
                it('should retrieve all the tests user is in', function (ab) {
                    ab.addTest(test.one);
                    ab.addTest(test.two);
                    ab.segment();
                ...
                it('should remove expired tests from being logged', function (ab) {
                ...
                it('should remove participation from tests that have been removed/renamed', function (ab) {
                    localStorage.setItem(
                        participationsKey,
                ...
                it('should allow the forcing of users in to a given test and variant', function (ab) {
                    ab.addTest(test.one);
            ...
            describe("Running tests", function () {
                ...
                it('should be able to start test', function (ab) {
                    ab.addTest(test.one);
                    ab.segment();
                    ab.run();
                ...
                it('should not to run the after the expiry date', function (ab) {
                    test.one.expiry = "2012-01-01";
                    ab.addTest(test.one);
                    ab.segment();
                    ab.run();
            ...
            describe("Analytics", function () {
                ...
                it('should tell me if an event is applicable to a test that I belong to', function (ab) {
                    ab.addTest(test.one);
                    ab.segment();
                ...
                it('should tell me if an event is applicable to a test with multiple event strings that I belong to', function (ab) {
                    ab.addTest(test.one);
                    ab.segment();
                ...
                it('should return a list of test names that are relevant to the event', function (ab) {
                    ab.addTest(test.one);
                    ab.addTest(test.two);
                    ab.segment();
                    var event = {};
                ...
                it('should return the variant of a test that current user is participating in', function (ab, deps) {
                    deps['common/modules/analytics/mvt-cookie'].overwriteMvtCookie(2);
                ...
                it('should generate a string for Omniture to tag the test(s) the user is in', function (ab, deps) {
                    deps['common/modules/analytics/mvt-cookie'].overwriteMvtCookie(2);
                ...
                it('should generate Omniture tags when there is two tests, but one cannot run', function (ab, deps) {
                    deps['common/modules/analytics/mvt-cookie'].overwriteMvtCookie(2);
                    test.one.canRun = function() { return false; };
                    ab.addTest(test.one);
                    test.two.audience = 1;
                ...
                it('should not generate Omniture tags when a test can not be run', function (ab, deps) {
                    deps['common/modules/analytics/mvt-cookie'].overwriteMvtCookie(2);
