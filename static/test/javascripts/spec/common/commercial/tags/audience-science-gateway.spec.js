define([
    ...
    describe('Audience Science Gateway', {
        moduleName: 'common/modules/commercial/tags/audience-science-gateway',
        mock: function () {
            return {
        ...
        specify: function () {
            ...
            it('should be able to get segments', function (audienceScienceGateway, deps) {
                ...
                deps['common/utils/storage'].local.set('gu.ads.audsci-gateway', stored);
            ...
            it('should return empty object if no segments', function (audienceScienceGateway, deps) {
                audienceScienceGateway.init();
                deps['common/utils/storage'].local.set('gu.ads.audsci-gateway', {});
                expect(audienceScienceGateway.getSegments()).toEqual({});
            });

            it('should return empty object if switch is off', function (audienceScienceGateway, deps) {
                deps['common/utils/config'].page.section = undefined;
                audienceScienceGateway.init();
                expect(audienceScienceGateway.getSegments()).toEqual({});
            });
