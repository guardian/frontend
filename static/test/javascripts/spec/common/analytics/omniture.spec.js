define([
    ...
    describe('Omniture', {
        moduleName: 'common/modules/analytics/omniture',
        mock: function () {
            return {
        ...
        specify: function () {
            ...
            it('should record clicks with correct analytics name', function (Omniture) {
                s.pageType = 'article';
            ...
            it('should correctly set page properties', function (Omniture, deps) {
            ...
            it('should correctly set cookieDomainPeriods for UK edition', function (Omniture) {
                s.linkInternalFilters = 'guardian.co.uk,guardiannews.co.uk';
                new Omniture(s, w).go();
            ...
            it('should log a page view event', function (Omniture) {
                new Omniture(s).go();

                expect(s.t).toHaveBeenCalledOnce();
            });

            it('should send event46 when a page has comments', function (Omniture) {
                new Omniture(s).go();
            ...
            it('should log a clickstream event', function (Omniture, deps) {
                var o         = new Omniture(s),
                    clickSpec = {
                ...
                o.go();
                deps['common/utils/mediator'].emit('module:clickstream:click', clickSpec);

                expect(s.tl).toHaveBeenCalledOnce();
            });

            it('should send event16 when social button has been clicked', function (Omniture, deps) {
                var o         = new Omniture(s),
                    clickSpec = {
                        target: document.documentElement,
                        samePage: false,
            ...
            it('should make a non-delayed s.tl call for same-page links', function (Omniture, deps) {
                var o                 = new Omniture(s),
                ...
                deps['common/utils/mediator'].emit('module:clickstream:click', clickSpecSamePage);

                expect(s.tl.withArgs(true, 'o', 'tag')).toHaveBeenCalledOnce();
            });

            it('should use local storage for same-host links', function (Omniture, deps) {
                var o         = new Omniture(s),
                    el        = document.createElement('a'),
                    clickSpec = {
                        target: el,
            ...
            it('should make a delayed s.tl call for other-host links', function (Omniture, deps) {
                var o         = new Omniture(s),
                    el        = document.createElement('a'),
                    clickSpec = {
                        target: el,
