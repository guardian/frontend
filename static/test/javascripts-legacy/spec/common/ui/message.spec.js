define([
    ...
    describe('Message', function () {
        ...
        it('Show a message', function () {
            new Message.Message('foo').show('hello world');
        ...
        it('Show a pinnable message', function () {
            new Message.Message('foo', {pinOnHide: true}).show('hello world');
            expect($('.js-site-message-copy').text()).toContain('hello world');
        ...
        it('Hide a pinnable message', function () {
            var m = new Message.Message('foo', {pinOnHide: true});
            m.show('hello world');
            m.hide();
            expect($('.js-site-message').hasClass('is-hidden')).toBeTruthy();
        ...
        it('Block messages from overwriting each other', function () {
            var m1 = new Message.Message('foo');
            var m2 = new Message.Message('bar');
            m1.show('message one');
            m2.show('message two');
        ...
        it('Allow \'important\' messages to overwrite an existing message', function () {
            var m1 = new Message.Message('a');
            var m2 = new Message.Message('b', { important: true });
            var m3 = new Message.Message('c');
            m1.show('message one');
            m2.show('message two');
        ...
        it('has option to stay permanently open', function () {
            new Message.Message('a', { permanent: true }).show('message one');
