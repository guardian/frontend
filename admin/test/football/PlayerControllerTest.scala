...
@DoNotDiscover class PlayerControllerTest extends FreeSpec with ShouldMatchers with PaFootballClient with ExecutionContexts with ConfiguredTestSuite with BeforeAndAfterAll with WithMaterializer with WithTestWsClient {
