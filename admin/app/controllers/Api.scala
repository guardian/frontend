...
object Api extends Controller with Logging with AuthLogging with ExecutionContexts with Strings {
  ...
  def proxy(path: String, callback: String) = AuthActions.AuthAction.async { request =>
  ...
  def tag(q: String, callback: String) = AuthActions.AuthAction.async { request =>
  ...
  def item(path: String, callback: String) = AuthActions.AuthAction.async { request =>
  ...
  def json(url: String) = AuthActions.AuthAction.async { request =>
