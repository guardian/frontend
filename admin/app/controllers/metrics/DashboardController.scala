...
object DashboardController extends Controller with Logging with AuthLogging {
  ...
  def renderDashboard() = AuthActions.AuthAction { request =>
  ...
  def renderAssets() = AuthActions.AuthAction{ request =>
