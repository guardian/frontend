...
import conf.{ExecutionContexts, Configuration}
      ...
      Async {
        OpenID.verifiedId.map {
          info =>
            ...
            val isTestUser = (credentials.email == "test.automation@gutest.com" && List("dev", "code", "gudev").contains(Configuration.environment.stage))
