...
object Dependencies {
  ...
  val apacheCommonsLang = "org.apache.commons" % "commons-lang3" % "3.18.0"
  ...
  val closureCompiler = "com.google.javascript" % "closure-compiler" % "v20250706"
  ...
  // Web jars
  val bootstrap = "org.webjars" % "bootstrap" % "5.3.7"
