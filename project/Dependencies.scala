...
object Dependencies {
  ...
  val closureCompiler = "com.google.javascript" % "closure-compiler" % "v20260428"
  ...
  val libPhoneNumber = "com.googlecode.libphonenumber" % "libphonenumber" % "9.0.29"
  ...
  val jqueryui = "org.webjars" % "jquery-ui" % "1.14.2"
