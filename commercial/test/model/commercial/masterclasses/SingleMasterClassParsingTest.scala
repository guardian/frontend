...
class SingleMasterClassParsingTest extends FlatSpec with Matchers {
  ...
  val json = """{ "background_color" : "FFFFFF",
               ...
               |  "description" : "<P>A bunch of HTML goes here. <a href='http://www.theguardian.com/guardian-masterclasses/how-to-use-twitter-effectively-david-schneider-david-levin-social-media-course'>Click here</a></P>",
