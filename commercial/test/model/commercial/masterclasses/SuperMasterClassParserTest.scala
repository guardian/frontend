...
class SuperMasterClassParserTest extends FlatSpec with Matchers {
   "MasterClass companion object" should "not create a masterclass object if there isn't at link to the Guardian" in {
   ...
   val json = """{ "background_color" : "FFFFFF",
                ...
                |  "description" : "<P>A bunch of HTML goes here. <a href='http://www.theguardian.com/guardian-masterclasses/how-to-use-twitter-effectively-david-schneider-david-levin-social-media-course'>Link to Masterclass page in the Guardian</a></P>",
   ...
   val jsonWithNoLink = """{ "background_color" : "FFFFFF",
                ...
                |  "category" : "seminars,conferences",
                |  "created" : "2013-02-15 09:50:35",
                |  "description" : "<P>A bunch of HTML goes here. <a href='http://www.google.com'>Link to Google</a></P>",
                |  "end_date" : "2013-04-21 17:00:00",
                |  "id" : 112342566,
                |  "link_color" : "EE6600",
                |  "locale" : "en",
