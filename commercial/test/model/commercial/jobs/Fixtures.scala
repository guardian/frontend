...
object Fixtures {
  ...
  val untaggedJobs = List(
    ...
    Job(4721342,
      ...
      new DateTime("2013-11-10T23:59:00.000Z"),
      isPremium = false,
      "Temp",
    ...
    Job(4726895,
      ...
      new DateTime("2013-10-31T23:59:00.000Z"),
      isPremium = false,
      "Permanent",
      "ARC Worker",
    ...
    Job(4729001,
      ...
      new DateTime("2013-10-24T23:59:59.000+01:00"),
      isPremium = false,
      "Permanent",
