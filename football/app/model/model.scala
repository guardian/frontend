...
object Teams {
  ...
  val teams: Seq[Team] = Seq(
    ...
    Team("15", "", "Nottm Forest", "Nottm Forest"),
    ...
    Team("17", "", "Sheff Wed", "Sheff Wed"),
    Team("20", "", "Milton Keynes Dons", "MK Dons"),
    ...
    Team("11", "", "Man City", "Man City"),
    Team("12", "", "Man Utd", "Man Utd"),
