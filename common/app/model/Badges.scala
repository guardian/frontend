...
object Badges {
  ...
  val generalElection2019 = Badge("politics/general-election-2019", Static("images/badges/general-election2019-badge.svg"))
  ...
  val allBadges = Seq(newArrivals, brexitGamble, roadToTheVote, brexitFrontline, brexitDividedGenerations,
    ...
    johnsonsPromises, rugbyWorldCup, behindTheLines, theEmptyDoorway,
    yemenAtWar, thePolluters, youthJustice, generalElection2019)
