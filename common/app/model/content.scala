...
class Content protected (val apiContent: ApiContentWithMeta) extends Trail with MetaData {
  ...
  override lazy val showBoostedHeadline: Boolean = false //getMeta("showBoostedHeadline")(_.asOpt[Boolean]).getOrElse(false)
  override lazy val showQuotedHeadline: Boolean = false //getMeta("showQuotedHeadline")(_.asOpt[Boolean]).getOrElse(false)
