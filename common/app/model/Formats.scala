...
object PressedContentFormat {
  ...
  val latestSnapFormat: OFormat[LatestSnap] = Json.format[LatestSnap]
  val linkSnapFormat: OFormat[LinkSnap] = Json.format[LinkSnap]
  val curatedContentFormat: OFormat[CuratedContent] = Json.format[CuratedContent]
  val supportingCuratedContentFormat: OFormat[SupportingCuratedContent] = Json.format[SupportingCuratedContent]
}
