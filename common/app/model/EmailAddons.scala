...
case object ArtWeekly extends ArticleEmailMetadata {
  val name = "Art Weekly"
  override val banner: Some[String] = Some("art-weekly.png")
...
case object MoneyTalks extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("money-talks.png")
...
case object TheBreakdown extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("the-breakdown.png")
...
case object WorldCupFiver extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("world-cup-fiver.png")
...
case object TheFiver extends ArticleEmailMetadata {
  val name = "The Fiver"
  override val banner: Some[String] = Some("the-fiver.png")
...
case object TheSpin extends ArticleEmailMetadata {
  val name = "The Spin"
  override val banner: Some[String] = Some("the-spin.png")
...
case object FirstEdition extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("first-edition.png")
...
case object FightToVote extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("fight-to-vote.png")
...
case object EuReferendum extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("brexit-briefing.png")
  def test(c: ContentPage): Boolean =
...
case object LabNotes extends ArticleEmailMetadata {
  val name = "Lab Notes"
  override val banner: Some[String] = Some("lab-notes.png")
...
case object HandwrittenMediaBriefing extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("media-briefing.png")
...
case object TheUpsideWeeklyReport extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("the-upside.png")
...
case object TheWeekInPatriarchy extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("the-week-in-patriarchy.png")
...
case object OutsideInAmerica extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("outside-in-america.png")
...
case object TheResistanceNow extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("the-resistance-now.png")
...
case object BeyondTheBlade extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("beyond-the-blade.png")
...
case object MorningMail extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("morning-mail.png")
  def test(c: ContentPage): Boolean =
...
case object VirtualRealityStudio extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("virtual-reality-studio.png")
...
case object WeekendReading extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("weekend-reading.png")
...
case object TheNewArrivals extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("the-new-arrivals.png")
...
case object FashionWeek extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("fashion-week.png")
...
case object CrosswordEditorsUpdate extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("crosswords-editors-update.png")
...
case object HearHere extends ArticleEmailMetadata {
  val name = "Hear Here"
  override val banner: Some[String] = Some("hear-here.gif")
...
case object AnimalsFarmed extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("animals-farmed-update.png")
...
case object USMorningBriefing extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("first-thing-2.png")
...
case object ObserverPictureArchive extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("observer-picture-archive.png")
...
case object GunsAndLiesInAmerica extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("guns_and_lies.png")
  def test(c: ContentPage): Boolean =
...
case object TheSnap extends ArticleEmailMetadata {
  val name = "The Snap"
  override val banner: Some[String] = Some("the-snap.png")
...
case object AndrewSparrowsElectionBriefing extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("andrew-sparrow-email.png")
  def test(c: ContentPage): Boolean =
...
case object CoronavirusTheWeekExplained extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("coronavirus.png")
...
case object CoronavirusAustraliaAtAGlance extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("banner-coronavirus-aus.png")
  def test(c: ContentPage): Boolean =
...
case object CoronavirusinThePacific extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("coronavirus-in-the-pacific.png")
  def test(c: ContentPage): Boolean =
...
case object USElectionBriefingForAustralia extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("us-election-briefing-australia.png")
  def test(c: ContentPage): Boolean =
...
case object TechScape extends ArticleEmailMetadata {
  val name = "TechScape"
  override val banner: Some[String] = Some("techscape.png")
  def test(c: ContentPage): Boolean =
...
case object Tokyo2020DailyBriefing extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("tokyo2020-daily-briefing.png")
  def test(c: ContentPage): Boolean =
...
case object Beijing2022DailyBriefing extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("winter-olympics-2022.png")
  def test(c: ContentPage): Boolean =
...
case object MovingTheGoalposts extends ArticleEmailMetadata {
  ...
  override val banner: Some[String] = Some("moving-the-goalposts.png")
  def test(c: ContentPage): Boolean =
...
case object HeadlinesEurope extends FrontEmailMetadata {
  ...
  override val banner: Some[String] = Some("headlines-eur.png")
}
...
object EmailAddons {
  ...
  implicit class EmailContentType(p: Page) {
    val email: Option[EmailMetadata[_ <: Page]] = p match {
      case c: ContentPage => articleEmails.find(_.test(c))
      case p: PressedPage => frontEmails.find(_.test(p))
    }

    val fallbackSeriesText: Option[Option[String]] = PartialFunction.condOpt(p) {
    ...
    lazy val address: String = email flatMap (_.address) getOrElse defaultAddress

    lazy val bodyClass: Option[String] = email map (_.name.toLowerCase().replace(' ', '-'))

    lazy val analyticsComponentId: String = email map (_.name.toLowerCase().replace(' ', '_')) getOrElse "article"
  }
}
