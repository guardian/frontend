...
object AudioFlagship {
  ...
  val description: String =
    "Listen to the story behind the headlines for a deeper understanding of the news. <strong>Every weekday with Rachel Humphreys, Nosheen Iqbal and Michael Safi</strong>."
