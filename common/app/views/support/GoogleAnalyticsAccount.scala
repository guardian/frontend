...
object GoogleAnalyticsAccount {
  ...
  val editorialProd: Tracker = Tracker("UA-78705427-1", "allEditorialPropertyTracker")
   ...
   */
  val editorialTest: Tracker = Tracker("UA-33592456-1", "guardianTestPropertyTracker", 5)
