...
import com.gu.contentapi.client.{BackoffStrategy, RetryableContentApiClient, ScheduledExecutor, ContentApiClient => CapiContentApiClient}
import common._
...
final case class CircuitBreakingContentApiClient(
  ...
  extends MonitoredContentApiClientLogic with RetryableContentApiClient {
    ...
    val retryAttempts = 3
    override val backoffStrategy = BackoffStrategy.constantStrategy(retryDuration, retryAttempts)
