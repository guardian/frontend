...
object VisitBritainHostedPages {
  ...
  private val activityImages: List[HostedGalleryImage] = List(
    HostedGalleryImage(
      url =  "https://media.guim.co.uk/cf6dbc732af6ac19bf1e599aa6601b5b90ee19f7/0_0_2778_1389/2000.jpg",
      title = "Ride the waves at Surf Snowdonia",
      caption = "Surf Snowdonia, Wales",
      credit = "© VisitBritain"
    ),
    HostedGalleryImage(
      url = "https://media.guim.co.uk/9b7492167eb6cd8e72014b8976b68ac8bc0fa91e/0_0_3898_2598/2000.jpg",
    ...
    HostedGalleryImage(
      url = "https://media.guim.co.uk/2209a44365a70bcadac9b3b5eedd38deb443352b/0_0_5616_3744/2000.jpg",
    ...
    HostedGalleryImage(
      url = "https://media.guim.co.uk/868ca67529af76a13ab6472698eb61d891a1f8bf/0_0_4296_2464/2000.jpg",
    ...
    HostedGalleryImage(
      url = "https://media.guim.co.uk/45957acc9dc793cf4b3eaebf000132ce98fffdb4/0_0_4874_3249/2000.jpg",
  ...
  private val cityImages: List[HostedGalleryImage] = List(
    HostedGalleryImage(
      url = "https://media.guim.co.uk/628946348eea991e04e02c8a3fd1420d2d6d44d0/0_0_5500_3270/2000.jpg",
    ...
    HostedGalleryImage(
      url = "https://media.guim.co.uk/6d65859087baf6907e0b78d772605c59db2460f0/0_0_5130_3420/2000.jpg",
    ...
    HostedGalleryImage(
      url = "https://media.guim.co.uk/baa07ffbf9ae2cc3d774e96b7cb6d8e68a877822/0_0_6000_4000/2000.jpg",
    ...
    HostedGalleryImage(
      url = "https://media.guim.co.uk/120e8a64c93eabdc9e926a0fa9f113553b24ea1a/0_0_5400_3600/2000.jpg",
    ...
    HostedGalleryImage(
      url = "https://media.guim.co.uk/9f332dbd5ecdb1ee1ac98398a3107419585ba01a/0_0_5200_3467/2000.jpg",
  ...
  private val coastImages: List[HostedGalleryImage] = List(
    HostedGalleryImage(
      url = "https://media.guim.co.uk/4ba0e60ffdd35406806fef4d7fbc4e57f2bbf865/0_0_2778_1389/2000.jpg",
      caption = "The Giant's Causeway, Northern Ireland",
      title = "Admire atmospheric rock formations at the Giant’s Causeway",
      credit = "© VisitBritain / Ben Selway"
    ),
    HostedGalleryImage(
      url = "https://media.guim.co.uk/3a8fbca7c261eb96c16d172fd300d9cfd9c34c6d/0_0_5641_3761/2000.jpg",
    ...
    HostedGalleryImage(
      url = "https://media.guim.co.uk/70d636b621ee1d8ae0f6af80cb360954f8ca0374/0_0_7000_2545/2000.jpg",
      caption = "Llandudno Pier, Wales",
      title = "Soak up the sea air from Llandudno Pier in Wales",
      credit = "© VisitBritain/ Lee Beel "
    ),
    HostedGalleryImage(
      url = "https://media.guim.co.uk/092c887ac1b501a4e62732e77f0d525c576dfa8e/0_0_7360_4912/2000.jpg",
    ...
    HostedGalleryImage(
      url = "https://media.guim.co.uk/ab74076edc14441685adfc0ee31c69c4f61d14cf/0_0_6456_4756/2000.jpg",
    ...
    HostedGalleryImage(
      url = "https://media.guim.co.uk/cb51196b14f73b0d4816dd8ad71f7fe6d2d5ade4/0_0_7795_5197/2000.jpg",
  ...
  private val countrysideImages: List[HostedGalleryImage] = List(
    HostedGalleryImage(
      url = "https://media.guim.co.uk/2b83d8f7ee872443b3a8b448f0b7633917c7198b/0_0_2778_1389/2000.jpg",
      title = "Marvel at Glen Coe, Scotland’s most iconic glen",
      caption = "Glen Coe, Scotland",
      credit = "© VisitBritain / Rod Edwards"
    ),
    HostedGalleryImage(
      url = "https://media.guim.co.uk/487d43802b7b21a03017ad54119d80c431992805/0_0_2778_1389/2000.jpg",
    ...
    HostedGalleryImage(
      url = "https://media.guim.co.uk/89594c0143261d9545477ca67877beb7fc4d5b4a/0_0_5838_3614/2000.jpg",
    ...
    HostedGalleryImage(
      url = "https://media.guim.co.uk/671a6045abd7abf07e8ecb3f7bff0fa6dcd0064f/0_0_2778_1389/2000.jpg",
      title = "Glen Coe, Scotland",
      credit = "© VisitBritain / Rod Edwards"
    ),
    HostedGalleryImage(
      url = "https://media.guim.co.uk/ad7018754bcb8ac2bccba847c773fe1e5839117a/0_0_5765_3841/2000.jpg",
