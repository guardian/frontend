...
object DfpAgent
  ...
  private lazy val highMerchandisingTargetsAgent = AkkaAgent[TargetedHighMerchandisingLineItems](TargetedHighMerchandisingLineItems())
  ...
  protected def highMerchandisingTargetedTags: TargetedHighMerchandisingLineItems = highMerchandisingTargetsAgent get()
  ...
  def refresh() {
    ...
    def grabHighMerchandisingLineItemTargetsFromStore(): TargetedHighMerchandisingLineItems ={
      val lineItems = for {
      ...
      TargetedHighMerchandisingLineItems(lineItems)
    }
    ...
    def updateHighMerchandisingTargets(freshData: TargetedHighMerchandisingLineItems): Unit ={
      highMerchandisingTargetsAgent sendOff { oldData =>
    ...
    updateHighMerchandisingTargets(grabHighMerchandisingLineItemTargetsFromStore())
