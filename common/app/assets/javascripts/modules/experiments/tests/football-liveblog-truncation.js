define([
    ...
    var $blocks,
        visible = 5,
        $cta = $.create('<button type="button" class="truncation-cta truncation-cta--continue js-continue-reading u-fauxlink" data-link-name="continue reading football liveblog"><i class="i i-arrow-down-double-blue"></i>Continue reading</button>');
