...
object css {
  ...
  def inlineNavigation(implicit request: RequestHeader, context: ApplicationContext): String = inline("head.navigation.garnett")
  ...
  def ampNavigation(implicit request: RequestHeader, context: ApplicationContext): String = inline("head.amp-navigation")
