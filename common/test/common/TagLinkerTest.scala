...
class TagLinkerTest extends FlatSpec with Matchers {
  ...
  "TagLinker" should "link tag at the start of the paragraph" in Fake {
  ...
  it should "link tag in the middle of the paragraph" in Fake {
  ...
  it should "link tag at the end of the paragraph" in Fake {
  ...
  it should "link if followed by a comma" in Fake {
  ...
  it should "link if followed by a question mark" in Fake {
  ...
  it should "not link as part of another word" in Fake {
  ...
  it should "not link as start of another word" in Fake {
  ...
  it should "not link as end of another word" in Fake {
  ...
  it should "escape the tag name" in Fake {
  ...
  it should "not link tags in articles that should be excluded from related content" in Fake {
