    ...
    val item = ApiContent(
      ...
      schemaOrg = Some(SchemaOrg(
        recipe = Some(Seq(SchemaRecipe(
          ...
          recipeInstructions = Some(Seq(
            RecipeStep(
              _atType = "HowToStep", text = "Open the can", name = Some("Open"), url = None, image = None
            ),
            RecipeStep(
              _atType = "HowToStep", text = "Pour the contents", name = Some("Pour"), url = None, image = None
            ),
          )),
