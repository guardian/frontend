                ...
                conf = {
                    ...
                    fixtures: [ // NB: element ids are required by the test, not by the actual Control module
                        '<div id="controls-a">' +
                            ...
                            '<div id="target-1"  class="nav-panel--target-1 is-off">content</div>' +
                            '<div id="target-2"  class="nav-panel--target-2">content</div>' +
                        '</div>',
                        ...
                        '<div id="controls-b">' +
                            ...
                            '<div id="target-1b"  class="nav-panel--target-1 is-off">content</div>' +
                            '<div id="target-2b"  class="nav-panel--target-2">content</div>' +
                        '</div>'
                    ]
            }
