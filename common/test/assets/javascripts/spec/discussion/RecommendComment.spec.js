    ...
    describe('Recommend Comment', function() {
        var context,
            ...
            recommendCommentFixture = {
                id: fixturesId,
                fixtures: [
                    '<div class="d-comment__action d-comment__action--recommend '+ RecommendComments.CONFIG.classes.button +'" data-comment-id="246">Recommended (<span class="d-comment__recommend-count js-recommend-count" data-recommend-count="12">12</span>)</div>'
                ]
            };
