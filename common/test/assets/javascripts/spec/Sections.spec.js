        ...
        describe("Sections", function() {
            ...
            var conf = {
                    ...
                    fixtures: [
                                ...
                                '<h2 class="article__zone"><a href="/test">Test Section</a></h2>',
                                '<h3 id="related-content-head" class="type-2 article__zone">Related content</h3>',
                                '<h3 id="related-content-head" class="type-2 article__zone">More on this story</h3>'
                              ]
            };
