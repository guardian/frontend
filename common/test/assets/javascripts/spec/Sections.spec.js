define([ 'common',
        ...
        describe("Sections", function() {        
            ...
            it("Should open and close in response to external control events", function() {
                ...
                expect(document.getElementById('sections-header').className).not.toContain('initially-off');
                
                common.mediator.emit('modules:control:change', ['sections-control-header', false]);
                expect(document.getElementById('sections-header').className).toContain('initially-off') 
