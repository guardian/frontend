...
object GetContainer {
  ...
  val specificContainers: Map[String, Map[String, Container]] = Map(
    ("au", Map(
      ...
      ("au/tone/features/feature-stories", FeaturesContainer(adSlot = Some(FirstAdSlot))),
      ("au/commentisfree/regular-stories", CommentContainer()),
      ("au/culture/regular-stories", FeaturesContainer(adSlot = Some(SecondAdSlot))),
    ...
    ("au-alpha", Map(
      ...
      ("au-alpha/features/feature-stories", FeaturesContainer(adSlot = Some(FirstAdSlot))),
      ("au-alpha/special/special-story", SportContainer()),
      ("au-alpha/contributors/feature-stories", CommentAndDebateContainer()),
      ("au-alpha/people-in-the-news/feature-stories", PeopleContainer(adSlot = Some(SecondAdSlot))),
    ...
    ("uk", Map(
      ...
      ("uk/tone/features/feature-stories", FeaturesContainer(adSlot = Some(FirstAdSlot))),
      ("uk/commentisfree/regular-stories", CommentContainer()),
      ("uk/culture/regular-stories", FeaturesContainer(adSlot = Some(SecondAdSlot))),
    ...
    ("uk-alpha", Map(
      ...
      ("uk-alpha/features/feature-stories", FeaturesContainer(adSlot = Some(FirstAdSlot))),
      ("uk-alpha/special/special-story", SportContainer()),
      ("uk-alpha/contributors/feature-stories", CommentAndDebateContainer()),
      ("uk-alpha/people-in-the-news/feature-stories", PeopleContainer(adSlot = Some(SecondAdSlot))),
    ...
    ("us", Map(
      ...
      ("us/tone/features/feature-stories", FeaturesContainer(adSlot = Some(FirstAdSlot))),
      ("us/commentisfree/regular-stories", CommentContainer()),
      ("us/culture/regular-stories", FeaturesContainer(adSlot = Some(SecondAdSlot))),
    ...
    ("us-alpha", Map(
      ...
      ("us-alpha/features/feature-stories", FeaturesContainer(adSlot = Some(FirstAdSlot))),
      ("us-alpha/special/special-story", SportContainer()),
      ("us-alpha/contributors/feature-stories", CommentAndDebateContainer()),
      ("us-alpha/people-in-the-news/feature-stories", PeopleContainer(adSlot = Some(SecondAdSlot))),
