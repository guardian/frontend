...
public class NavigationSteps {
    ...
    public void the_menu_should(String tabName, String menuState) throws Throwable {
    	String menuId = "nav-panel--" + tabName.toLowerCase().replace(" ", "");
    ...
    public void I_click_on_a_top_story_link() throws Throwable {
    	...
    	webDriver.click(webDriver.findElement(By.cssSelector(".nav-panel--topstories li a")));
    }
    ...
    public void the_top_story_link_should_have_a_of(String cssProperty, String expectedColor) throws Throwable {
    	...
    	assertEquals(expectedColor, webDriver.getElementCssValue(By.cssSelector(".nav-panel--topstories li a"), cssProperty));
    }
