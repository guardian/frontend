...
import com.gu.fronts.integration.test.common.util.CssSelector;

/**
 * Custom {@link By} implementation which matches a provided string value to an attribute of name
 * {@link CssSelector#TEST_ATTR_NAME} by using {@link ByCssSelector}
 */
public class ByTestAttributeSelector extends ByCssSelector {
    ...
    public ByTestAttributeSelector(String testAttributeValue) {
        super(new StringBuilder().append("[").append(TEST_ATTR_NAME).append("=").append(testAttributeValue).append("]").toString());
    }
