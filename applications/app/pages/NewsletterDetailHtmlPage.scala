...
import views.html.signup.newsletterDetailContent
import html.HtmlPageHelpers.ContentCSSFile
import staticpages.NewsletterSeriesDetailPage
import views.html.stacked

object NewsletterDetailHtmlPage extends HtmlPage[NewsletterSeriesDetailPage] {
  ...
  def html(page: NewsletterSeriesDetailPage)(implicit
      request: RequestHeader,
      applicationContext: ApplicationContext,
  ): Html = {
    implicit val p: NewsletterSeriesDetailPage = page
