define([
    ...
    Collection.prototype.load = function(opts) {
        ...
        .done(function(raw) {
            ...
            self.collectionMeta.updatedBy(raw.updatedEmail === vars.CONST.identity.email ? 'you' : raw.updatedBy);
    ...
    Collection.prototype.populate = function(rawCollection) {
        ...
        if (this.raw) {
            ...
            if (this.hasOpenArticles()) {
                this.state.hasConcurrentEdits(this.raw.updatedEmail !== vars.CONST.identity.email && this.state.lastUpdated());
