...
const stubApiRequests = () => {
	...
	// stub headlines
	stubApiRequest('https://api.nextgen.guardianapps.co.uk/container/data/uk-alpha/news/regular-stories.json', regularStories);
	// stub most viewed bottom
	stubApiRequest('https://api.nextgen.guardianapps.co.uk/most-read/politics.json?dcr=true', mostRead);
}
