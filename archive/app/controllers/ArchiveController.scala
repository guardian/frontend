...
class ArchiveController(redirects: RedirectService, renderer: Renderer, val controllerComponents: ControllerComponents) extends BaseController with Logging with ExecutionContexts {
