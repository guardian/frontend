    ...
    return {
        ...
        GuardianSansWebWoff2: {
            options: {
                ...
                fonts: [{
                    ...
                    file: options.webfontsDir + 'hinting-off_kerning-off/latin1/GuardianSansWeb/GuardianSansWeb-Light.woff2',
                    'font-weight': '200',
                    format: 'woff'
                }]
            }
        ...
        GuardianSansWebWoff: {
            options: {
                ...
                fonts: [{
                    'font-family': '"Guardian Sans Web"',
                    file: options.webfontsDir + 'hinting-off_kerning-off/ascii/GuardianSansWeb/GuardianSansWeb-Light.woff',
                    'font-weight': '200',
                    format: 'woff'
                }]
            }
        ...
        GuardianSansWebTtf: {
            options: {
                ...
                fonts: [{
                    'font-family': '"Guardian Sans Web"',
                    file: options.webfontsDir + 'hinting-off_kerning-off/ascii/GuardianSansWeb/GuardianSansWeb-Light.ttf',
                    'font-weight': '200',
                    format: 'ttf'
                }]
            }
