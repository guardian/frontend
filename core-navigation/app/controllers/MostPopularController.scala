      ...
      sectionPopular :+ globalPopular match {
        ...
        case popular => Cached(900) {
          JsonComponent(
            ...
            "faciaHtml" -> views.html.fragments.containers.popular(Config("uk/popular/regular-stories", contentApiQuery = None, Option("Most popular"), collectionTone = None, href = None), Collection(popular.headOption.map(_.trails).getOrElse(Nil).take(10), None), PopularContainer(showMore = true), containerIndex = 1),
