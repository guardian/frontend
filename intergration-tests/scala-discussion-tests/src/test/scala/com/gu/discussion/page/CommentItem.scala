...
case class CommentItem(implicit driver: WebDriver) {
  ...
  private def commentBody = latestComment.elements(By.className("d-comment__body"))
  private def showCommentButton = latestComment.elements(By.className("d-comment-box__show-parent"))
  private def replyToCommentButton = latestComment.elements(By.className("d-comment__action--reply"))
  private def commentTextArea = latestComment.elements(By.cssSelector("textarea[name=\"body\"]"))
  private def postReplyButton = latestComment.elements(By.className("d-comment-box__submit"))
  private def cancelReplyButton = latestComment.elements(By.className("d-comment-box__cancel"))
  private def pickCommentButton = latestComment.elements(By.className("d-comment__action--pick"))
  private def reportCommentButton = latestComment.elements(By.className("d-comment__action--report"))
  private def reportSelectControl = latestComment.elements(By.name("category"))
  private def reportTextArea = latestComment.elements(By.id("d-report-comment__reason"))
  private def reportEmail = latestComment.elements(By.id("d-report-comment__email"))
  private def sendReportButton = latestComment.elements(By.cssSelector("button.d-report-comment__submit"))
  private def showMoreRepliesButton = latestComment.elements(By.className("d-show-more-replies"))
  private def recommendCommentButton = latestComment.elements(By.className("d-comment__recommend-button"))
  private def commentAuthorAvatar = latestComment.elements(By.className("d-comment__avatar"))
  private def commentAuthorLink = latestComment.elements(By.cssSelector(".d-comment__author a"))
  private def commentTimeStamp = latestComment.elements(By.className("d-comment__timestamp"))
  private def oldRecommendCommentCount = latestComment.elements(By.cssSelector(".d-comment__recommend-count--old"))
  private def newRecommendCommentCount = latestComment.elements(By.cssSelector(".d-comment__recommend-count--new"))
