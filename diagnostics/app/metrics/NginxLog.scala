...
object NginxLog {
  ...
  object pxgif {
    ...
    val safari = CountMetric("diagnostics", "safari", "Mobile Safari", "Accesses to /px.gif from Mobile Safari agents")
    ...
    val metrics: Seq[Metric] = Seq(total, mobileSafari, safari, mobileFirefox, firefox, operaMobile, chromeMobile, chrome, androidWebkit, ieMobile, nokia, other)
