            ...
            common: {
                options: {
                    specs: [
                        ...
                        'common/test/assets/javascripts/spec/AudienceScience.spec.js',
                        'common/test/assets/javascripts/spec/Australia.spec.js',
//                        'common/test/assets/javascripts/spec/AutoUpdate.spec.js',
                        'common/test/assets/javascripts/spec/Aware.spec.js',
                        'common/test/assets/javascripts/spec/Canary.spec.js',
                        'common/test/assets/javascripts/spec/Clickstream.spec.js',
                        'common/test/assets/javascripts/spec/CommentCount.spec.js',
                        'common/test/assets/javascripts/spec/Common.spec.js',
                        'common/test/assets/javascripts/spec/Control.spec.js',
                        'common/test/assets/javascripts/spec/Cookies.spec.js',
                        'common/test/assets/javascripts/spec/Debug.spec.js',
                        'common/test/assets/javascripts/spec/Detect.spec.js',
//                        'common/test/assets/javascripts/spec/DocumentWrite.spec.js',
                        'common/test/assets/javascripts/spec/Errors.spec.js',
                        'common/test/assets/javascripts/spec/Expandable.spec.js',
...
//                        'common/test/assets/javascripts/spec/GallerySwipe.spec.js',
                        'common/test/assets/javascripts/spec/Id.spec.js',
                        'common/test/assets/javascripts/spec/Images.spec.js',
                        'common/test/assets/javascripts/spec/InlineLinkCard.spec.js',
                        'common/test/assets/javascripts/spec/Interactive.spec.js',
                        'common/test/assets/javascripts/spec/LazyLoad.spec.js',
...
//                        'common/test/assets/javascripts/spec/MoreMatches.spec.js',
                        'common/test/assets/javascripts/spec/Omniture.spec.js',
//                        'common/test/assets/javascripts/spec/OmnitureLib.spec.js',
//                        'common/test/assets/javascripts/spec/Overlay.spec.js',
                        'common/test/assets/javascripts/spec/Pad.spec.js',
                        'common/test/assets/javascripts/spec/PageConfig.spec.js',
//                        'common/test/assets/javascripts/spec/PlatformSwitch.spec.js',
...
//                        'common/test/assets/javascripts/spec/RelativeDates.spec.js',
                        'common/test/assets/javascripts/spec/Router.spec.js',
                        'common/test/assets/javascripts/spec/Sections.spec.js',
//                        'common/test/assets/javascripts/spec/Storage.spec.js',
//                        'common/test/assets/javascripts/spec/Tabs.spec.js',
                        'common/test/assets/javascripts/spec/TogglePanel.spec.js',
//                        'common/test/assets/javascripts/spec/TopStories.spec.js',
//                        'common/test/assets/javascripts/spec/TrailblockShowMore.spec.js',
                        'common/test/assets/javascripts/spec/TrailblockToggle.spec.js',
                        'common/test/assets/javascripts/spec/Url.spec.js',
                        'common/test/assets/javascripts/spec/UserPrefs.spec.js',
                    ],
                    vendor: [
